...
knn_param_grid = {"n_neighbors": np.arange(2, 31)} # burada yaptıgımımz 2-32 arasında tektek küme sayılarınna göre en iyi sonuc veren parametre yani küme sayısnın  bulucaz
