...
nb_states = environment.observation_space.n # matrisin oda sayısı 16
nb_actions = environment.action_space.n # 4 tane haraket edebilecek 
qtable = np.zeros((nb_states, nb_actions))

print("Q-table:")
print(qtable)

action = environment.action_space.sample()# rastgele aksiyon gerçeklşir 1 kere
"""
sol: 0
asagi: 1
sag: 2
